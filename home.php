            ...
            <div class="MuiContainer-root MuiContainer-fixed MuiContainer-maxWidthLg">
                <div style="position: relative;">
                    <div class="form__Container-sc-1clt5p5-5 hjVoiM">
                        ...
                        <div class="typography__HeadingText-sqf0j0-0 fhgaIb">Touchless transfer for your needs</div>
                        <form class="form__Form-sc-1clt5p5-2 deFwsi" id="loginForm">
                            <div class="form__Input-sc-1clt5p5-3 ksXRcz">
                                ...
                                <input type="email" class="form__Input-sc-1clt5p5-3 ksXRcz" name="log_username" placeholder="Email" value="" autocomplete="off" required />
                            </div>
                            <div class="form__Input-sc-1clt5p5-3 ksXRcz">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" size="17" height="17" width="17" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <input type="password" class="form__Input-sc-1clt5p5-3 ksXRcz" name="log_password" placeholder="Password" value="" required />
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" size="17" height="17" width="17" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <a style="color: #fff; text-align: right; width: 100%;" href="forgot">Forgot password?</a>
								<button class="form__Button-sc-1clt5p5-0 jrOeAQ" type="submit">Log in</button>
                            <a class="form__ButtonUnstyled-sc-1clt5p5-1 TlXWl" href="signup">
                                Sign up
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" size="17" color="white" style="color: white;" height="17" width="17" xmlns="http://www.w3.org/2000/svg">
                                    <path
...
<?php
	...
	if(isset($_GET["activation"]))
	{
		...
		$sql = "SELECT ID, email FROM users WHERE activation_code='$id' AND is_active='0' LIMIT 1";
		...
		if($row && count($row) >= 1)
		{
		   $sql = "UPDATE users set is_active='1', updatedAt=now() where activation_code='$id' AND is_active='0'";
		   $query = mysqli_query($db_conx, $sql);
		   if (!$query) {
			 ...
			 $header = "Success!";
			 $icon = "success";
			 $message =  "Success!, Your account is now active. Click <a href='index.php'>here</a> to login <br /> Thanks";	 
		}else
		{
			$message =  "We can't find the activattion code or the code has expired";
		}	
?>
	<script>
		$(function(){
			...
			pop_alert("<?php echo $header; ?>", "<?php echo $message; ?>", "<?php echo $icon; ?>", false);
		})
	</script>
<?php
	}
